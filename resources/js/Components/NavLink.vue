...
const classes = computed(() =>
    props.active
        ? "inline-flex items-center px-1 pt-1 font-medium leading-5 text-gray-900 focus:outline-none focus:border-primary-700 transition duration-150 ease-in-out"
